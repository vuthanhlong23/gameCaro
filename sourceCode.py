...
def info():
    ...
    text = Label(six, text="Leader:Nguyen Thi Anh Ðào \n Secretary: Phan Ngoc Thiên Ân \n Main Developer: Vu Công Minh \n Sub Developer:Truong Hoàng Phúc, Vu Thành Long \n\n <<Thank You For Playing>>",font=("Calibri", 20, "bold"),)
...
blue.place(x=400,y=330)
red=Button(two,text="Group's Informaton",font="none 10 bold",width=15,height=3,command=info)
red.place(x=400,y=410)
Sett=Button(two,text="Settings",font="none 10 bold",width=15,height=3,command=Setting)
Sett.place(x=400,y=490)
two.mainloop()
